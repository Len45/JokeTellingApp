 ...
 * on 2016-10-17 at 02:29:56 UTC 
 * Modify at your own risk.
 */

package com.example.manoj2prabhakar.builitbigger.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigge-manoj.appspot.com/_ah/api/";
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "myApi/v1/jokesbean/";
   ...
   * @return the request
   */
  public GetJokes getJokes(java.lang.String name) throws java.io.IOException {
    GetJokes result = new GetJokes(name);
    initialize(result);
    return result;
  }

  public class GetJokes extends MyApiRequest<com.example.manoj2prabhakar.builitbigger.backend.myApi.model.JokesBean> {
     ...
     * @since 1.13
     */
    protected GetJokes(java.lang.String name) {
      super(MyApi.this, "GET", REST_PATH, null, com.example.manoj2prabhakar.builitbigger.backend.myApi.model.JokesBean.class);
    ...
    public GetJokes setName(java.lang.String name) {
      this.name = name;
      return this;
    }
